...
/** @file STK_MixtureGamma_ak_bk.h
 *  @brief In this file we define the Gamma_pk_ak_bk and Gamma_p_ak_bk models.
 **/

#ifndef STK_MIXTUREGAMMA_AK_BK_H
#define STK_MIXTUREGAMMA_AK_BK_H
...
namespace STK
{
template<class Array>class MixtureGamma_ak_bk;

namespace hidden
{
/** @ingroup Clustering
 * Traits class for the MixtureGamma_ak_bk traits policy
 **/
template<class Array_>
struct MixtureTraits< MixtureGamma_ak_bk<Array_> >
{
  typedef Array_ Array;
  /** Type of the structure storing the parameters of a MixtureGamma_ak_bk model*/
...
/** @ingroup Clustering
 *  Structure encapsulating the parameters of a MixtureGamma_ak_bk model.
 */
template<>
...
/** @ingroup Clustering
 *  MixtureGamma_ak_bk is a mixture model of the following form
 * \f[
...
class MixtureGamma_ak_bk : public MixtureGammaBase< MixtureGamma_ak_bk<Array> >
{
  public:
    typedef MixtureGammaBase< MixtureGamma_ak_bk<Array> > Base;
    using Base::param_;
    using Base::p_data;
    using Base::meanjk;
 ...
 */
template<class Array>
void MixtureGamma_ak_bk<Array>::randomInit( CArrayXX const*  p_tik, CPointX const* p_nk) 
{
  // compute moments
  this->moments(p_tik);
...
template<class Array>
bool MixtureGamma_ak_bk<Array>::run( CArrayXX const*  p_tik, CPointX const* p_nk) 
{
...
#endif /* STK_MIXTUREGAMMA_AK_BK_H */
