...
class MixtureGamma_ajk_bjk : public MixtureGammaBase< MixtureGamma_ajk_bjk<Array> >
{
  public:
     ...
     **/
    inline MixtureGamma_ajk_bjk( int nbCluster) : Base(nbCluster) {}
    /** copy constructor
     *  @param model The model to copy
     **/
    inline MixtureGamma_ajk_bjk( MixtureGamma_ajk_bjk const& model): Base(model) {}
    /** destructor */
    inline ~MixtureGamma_ajk_bjk() {}
