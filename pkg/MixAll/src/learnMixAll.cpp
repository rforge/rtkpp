                              ...
                              , SEXP nbCore )
{
  ...
  // create a launcher
  STK::LearnLauncher launcher(model, models, algo, critName);
  // return result
 ...
 */
RcppExport SEXP learnMixedData( SEXP model, SEXP algo, SEXP critName, SEXP nbCore  )
{
  BEGIN_RCPP
...
#endif
  // create a launcher
  STK::LearnLauncher launcher(model, algo, critName);
  // return result
  return Rcpp::wrap(launcher.run());
