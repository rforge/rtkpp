...
{
  typedef Clust::BridgeTraits<Clust::Categorical_pjk_>::Mixture Mixture;
...
{
  typedef Clust::BridgeTraits<Clust::Categorical_pk_>::Mixture Mixture;
  typedef Clust::BridgeTraits<Clust::Categorical_pk_>::Type Type;
