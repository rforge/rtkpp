...
################################################################################
#' Create an instance of [\code{\linkS4class{ClusteringAlgo}}] class 
#'
...
#'
#' @return a [\code{\linkS4class{ClusteringAlgo}}] object
#' @author Serge Iovleff, with contributions from V. Kubicki
#' @export
#'
clusteringAlgo <- function( algo="EM", nbIteration=200, epsilon=1e-08)
{ new("ClusteringAlgo", algo=algo, nbIteration=nbIteration, epsilon=epsilon)}

###################################################################################
#' @title [\code{\linkS4class{ClusteringAlgo}}] class for clustering algorithms.
#'
#' @description
#' This class encapsulate the parameters of estimation algorithms of the rtkpp Clustering
#' methods.
#'
...
#'
#' @name ClusteringAlgo
#' @rdname ClusteringAlgo-class
#' @aliases ClusteringAlgo-class
#' @exportClass ClusteringAlgo
setClass (
  ...
  validity = function(object)
  {
    ...
    {  stop("Algorithm is not valid. See ?clusteringAlgo for the list of available algorithms.")}
    # for nbIteration
...
###################################################################################
#' Initialize an instance of the [\code{\linkS4class{ClusteringAlgo}}] class.
#' 
...
#' @aliases print print-algo,ClusteringAlgo-method
setMethod(
    f="print",
    signature=c("ClusteringAlgo"),
    function(x,...){
      cat("****************************************\n")
      cat("*** rtkpp ClusteringAlgo:\n")
...
# @docType methods
#' @rdname show-methods
#' @aliases show show-algo,ClusteringAlgo-method
setMethod(
    f="show",
    signature=c("ClusteringAlgo"),
    function(object){
...
#' @aliases [,ClusteringAlgo-method
setMethod(
    f="[", 
    signature(x = "ClusteringAlgo"),
