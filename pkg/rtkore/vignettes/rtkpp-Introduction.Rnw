...
\texttt{Rcpp::wrap} for the \texttt{C++} classes defined in \stkpp{}.
...
\section{Building a huge package using \rtkore{}}
...
\url{https://sourceforge.net/projects/stkpp/files/R%20packages/countMissings_1.0.tar.gz/download}
