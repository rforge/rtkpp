...
%-------------------------
% preamble for nice listings and notes
...
\item \code{lcdf(t)} return the $\log$-cumulative distribution function value
$\log F(t)$
\item \code{cdfc(t)} return the complementary cumulative distribution function
value (the survival function) $1-F(t)$
\item \code{lcdfc(t)} return the $\log$-complementary cumulative distribution
